...
class AccountController extends Controller
{
    ...
    public function processForgotPassword(Request $request) {
        ...
        if (!$user) {
            return redirect()->route('account.forgotPassword')->withErrors('User not found.');
        }
        ...
        try {
            ...
            return redirect()->route('account.forgotPassword')->withErrors('Failed to send email: ' . $e->getMessage());
        }
