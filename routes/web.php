...
use App\Http\Controllers\admin\AuthorizedDashboardController;
...
Route::middleware(['auth', CheckAdmin::class])->prefix('admin')->group(function () {
  Route::get('/dashboard', [AuthorizedDashboardController::class, 'showDashboard'])->name('admin.dashboard');
